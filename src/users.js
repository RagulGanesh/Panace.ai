export const Users=[
    ...
    {
      "disease": "accidentcerebrovascular",
      "symptoms": [
        "dysarthria",
        "asthenia",
        "speech  slurred",
    ...
    {
      "disease": "infection  urinary tract",
      "symptoms": [
        "fever",
        "dysuria",
        "hematuria",
    ...
    {
      "disease": "degenerativepolyarthritis",
      "symptoms": [
        "pain",
        "food  intolerance",
        "numbness  of hand",
    ...
    {
      "disease": "Pneumocystiscariniipneumonia",
      "symptoms": [
        "yellow sputum",
        "cachexia",
        "chill",
    ...
    {
      "disease": "primary  carcinoma of the liver cells",
      "symptoms": [
        "mass of body structure",
        "splenomegaly",
        "lesion",
